            ...
            <div class="navbar sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i> <span class="fa arrow"></span>Materiel</a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Nouvel Emprunt</a>
                                </li>
                                <li>
                                    <a href="#">Nouveau Materiel</a>
                                </li>
                            </ul>
                        </li>
                        
                        <li>
                            <a href="#"><i class="fa fa-building fa-fw"></i>Materiel Sorti</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-home fa-fw"></i><span class="fa arrow"></span> Materiel en Stock </a>

                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#"> <i class="fa fa-exclamation-triangle"></i> Stock d'alerte</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-home fa-fw"></i>Inventaire </a>
                        </li>
                        <!-- <li>
                    ...
                    <div style="background-image: url('../ressources/img/appart4.jpg');" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <legend> <h2 class="text-center">Emprunt</h2> </legend>
                                
                                    <div class="form-group">
                                        <input type="text" name="" id="" class="form-control" placeholder="Entrez le identifant Emprunteur" >
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="" placeholder="Nom Emprunteur" disabled="disabled">
                                    </div>
                                        
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="" placeholder="Prenom Emprunteur" disabled="disabled">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="" placeholder="Contact" disabled="disabled">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="" placeholder="Fonction" disabled="disabled">
                                    </div>

                                    

                                    <legend>
                                        <h2 class="text-center">Materiel Emprunte</h2>
                                    </legend>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <legend>
                                    <h2 class="text-center">Maison Concernee</h2>
                                </legend>

                                 <div class="form-group">
                                    <input type="text" name="" id="" class="form-control" placeholder="code maison concernee">
                                </div>
                                <legend>
                                    <h2 class="text-center">Etape de Construction Concernee</h2>
                                </legend>
