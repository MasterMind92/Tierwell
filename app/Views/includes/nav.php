<!-- Navigation -->
    <nav class="navbar fixed-top navbar-expand-lg  fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.php"><img src="../ressources/img/logoW.png" alt="" width="150"> </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu " aria-labelledby="authDrop">
                <a class="dropdown-item" href="Login.php">Suivi de souscription</a>
                <a class="dropdown-item" href="Login.php">Suivi des construction</a>
                <a class="dropdown-item" href="Login.php">Suivi du materiel de construction</a>
                <a class="dropdown-item" href="Login.php">Suivi de recouvrement</a>
                <a class="dropdown-item" href="Login.php">Suivi de litiges</a>
              </div>
            </li>
          </ul>
        </div>
